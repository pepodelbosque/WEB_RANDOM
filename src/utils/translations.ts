...
export const translations = {
    ...
    description: 'Here we present those who brought this project to life, from the creative voices to those who shared their dreams to transform them into artwork. Katherine Hoch and Eduardo Pino generously open their dreamlike experiences, inviting us to explore with their dreams the boundaries between the real and the imagined. Camila Estrella, theorist and participant, contributes from reflection and also shares one of the dreams that inspired the work. Sebastián Vidal, curator and theorist, accompanies guiding the general vision and dialogue between art and technology. Barbara Oettinger, visual artist and filmmaker, and Pepo Sabatini, filmmaker and 3D animator, jointly created the imagery and aesthetic conception of the project, fusing creative vision and technique. Barbara brings a sensitive and poetic perspective that permeates the proposal, while Pepo contributes his vision and expertise within the 3D universe. Each one, from their place, builds a collective framework that crosses art, technology and dreams.',
      ...
      crew: {
        ...
        pepo: {
          ...
          bio: 'Desarrollo estructural narrativo y creativo, desde el mundo del cine al video juego.',
        },
        sebastian: {
        ...
        camila: {
          ...
          role: 'Teórica y Soñadora',
          bio: 'Aporta reflexión y comparte uno de los sueños que inspiró la obra.',
        },
        fer: {
          name: 'FER AGUIRRE',
          role: 'Animadora',
          bio: 'Experimentando con el movimiento y el lenguaje.',
        },
        jav: {
          name: 'JAV ROJAS',
          role: 'Programador',
          bio: 'Desde lo animado a lo inerte, todo en reacción.',
        },
        ignacio: {
          name: 'IGNACIO CONCHA',
          role: 'Programador',
          bio: 'Desarrollando ideas y atajos en lo visual.',
        },
        lost: {
          name: 'LOST TROPICALES',
          role: 'Compositor Músical',
          bio: 'Antes del fúturo narrativa auditiva.',
        },
        chico: {
          name: 'CHICO LAGOS',
          role: 'Diseño Sonoro',
  ...
  es: {
    ...
    services: {
      title: 'Tripulación',
    description: 'Kate Hoch y Eduardo Pino abren\ngenerosamente sus experiencias\noníricas, invitándonos a explorar con\nsus sueños las fronteras entre lo\nreal y lo imaginado. Camila Estrella,\nteórica y participante, aporta desde\nla reflexión y también comparte uno\nde los sueños que inspiró la obra.\nSebastián Vidal, curador y teórico,\nacompaña guiando la visión general y\nel diálogo entre arte y tecnología.\nPepo Sabatini, cineasta y animador 3D,\ny Barbara Oettinger, artista visual y\nrealizadora, crearon el imaginario y\nla concepción estética del proyecto,\nfusionando visión creativa y técnica.\nCada uno, desde su lugar, construye\nun entramado colectivo que atraviesa\nel arte, la tecnología y los sueños.',
      webDevelopment: {
        title: 'PERONAS',
